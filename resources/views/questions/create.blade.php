                        ...
                        <form action="{{ route('questions.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="question-body"
                                          class="form-control {{ $errors->has('body') ? 'is-invalid':'' }}" rows="10">{{ old('body') }}</textarea>
                                @if($errors->has('body'))
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-outline-primary btnlg">Ask this question</button>
                            </div>
