...
<div class="form-group">
    ...
    <textarea name="body" id="question-body"
              class="form-control {{ $errors->has('body') ? 'is-invalid':'' }}" rows="10">{{ old('body',$question->body) }}</textarea>
    @if($errors->has('body'))
...
<div class="form-group">
    <button type="submit" class="btn btn-outline-primary btnlg">{{ $buttonText }}</button>
</div>
